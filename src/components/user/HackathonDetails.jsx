      ...
      <div className="flex-grow py-12 px-4 flex flex-col items-center justify-center w-full">
        ...
        >
          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              <div className="relative group self-start sm:self-auto shrink-0">
                <DsfrutarLogo inline className="text-2xl drop-shadow-[0_0_15px_rgba(0,255,255,0.3)] transition-all duration-300 group-hover:scale-105" />
              </div>
              <div className="text-left flex flex-col justify-center min-w-0">
                ...
                >
                  <span className="bg-blue-500/20 text-[#00FFFF] px-2 py-0.5 rounded-sm border border-blue-500/50 shadow-[0_0_10px_rgba(0,255,255,0.2)] mr-2 md:mr-3 inline-block text-[10px] uppercase leading-none shrink-0">BRIEFING</span>
                ...
                <div className="flex flex-wrap items-center gap-x-3 gap-y-1.5 mt-2 font-mono-custom text-xs">
                  {/* Node Status Caps */}
                  <span className="flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-cyan-500/10 border border-cyan-500/30 text-emerald-100">
                    <span className="relative flex h-1.5 w-1.5">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-cyan-400 opacity-75"></span>
                      <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-cyan-500"></span>
                    </span>
                    NODE: <span className="text-cyan-400 font-bold">{teamId}</span>
                  </span>
                  {resolvedTeamName && (
          ...
          <div className="flex flex-col gap-6 relative z-20">
            <motion.div
              variants={itemVariants}
              className="w-full glass-panel p-6 rounded-none border border-zinc-800/80 hover:border-blue-400/30 transition-colors duration-300 flex flex-col"
            >
              <div>
                <h2
            ...
            >
              {/* Roster Header */}
              <div className="flex items-center justify-between mb-4 px-2 text-xs text-[#00FFFF]/80 font-orbitron">
                <div
                  className="flex items-center gap-2"
                >
                  <span className="font-bold tracking-widest uppercase text-[#00FFFF]">Team Roster</span>
                </div>
              ...
              <div className="flex-1 transition-all duration-300 min-h-[300px] flex flex-col justify-start">
                ...
                {loadingMembers ? (
                  <div className="flex-1 flex flex-col items-center justify-center gap-3 text-sm text-[#00FFFF]/70 font-mono-custom py-10">
                    <div className="w-6 h-6 border-2 border-blue-400 border-t-transparent rounded-none animate-spin"></div>
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-start gap-4">
                            ...
                            <div className="w-10 h-10 rounded-none glass-panel group-hover:border-blue-400/30 flex flex-col items-center justify-center font-mono-custom transition-colors duration-300">
                              <span className="text-[9px] text-slate-500 font-semibold uppercase leading-none">MEM</span>
                              <span className="text-xs font-bold text-[#00FFFF] leading-none mt-1">0{index + 1}</span>
                            </div>

                            {/* Member Info */}
                            <div className="flex-1 min-w-0">
                              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1.5">
                                <h4 className="text-base font-bold text-white font-mono-custom tracking-wide truncate group-hover:text-[#00FFFF] transition-colors duration-300">
                                  {member.name}
                                </h4>
                                <span className="text-[11px] font-mono-custom font-semibold text-[#00FFFF] bg-blue-400/5 px-2 py-0.5 rounded border border-blue-400/20 self-start sm:self-auto shadow-[0_0_8px_rgba(0,255,255,0.05)]">
                                  {member.regNo}
                                </span>
                              </div>
                              ...
                              <div className="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-1 text-xs font-mono-custom text-slate-400">
                                ...
                                <div className="flex items-center gap-1.5 mt-0.5">
                                  ...
                                  <span className="text-[#00FFFF] font-bold uppercase">{member.year}</span>
                                </div>
                                <div className="flex items-center gap-1.5 mt-0.5">
                                  <span className="text-slate-600 font-bold">Branch:</span>
                                  <span className="text-cyan-400 font-extrabold uppercase">{member.branch}</span>
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="mt-3 pt-3 border-t border-zinc-800/60">
                              <div className="text-[#00FFFF] font-bold uppercase tracking-wider mb-2">Participation Certificate:</div>
                                  ...
                                  <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                                    ...
                                    {feedbackEnabled && !hasFeedback && (
                                      <motion.button
                                        ...
                                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-blue-500/10 border border-blue-500/40 hover:bg-blue-500/20 hover:border-blue-400 text-[#00FFFF] font-bold uppercase text-[8px] tracking-wider transition-all duration-300 cursor-pointer hover:shadow-[0_0_10px_rgba(0,255,255,0.2)] hover:scale-[1.02] active:scale-[0.98]"
                                      >
                                    ...
                                    {hasFeedback && (
                                      <span className="inline-flex items-center gap-1 text-[8px] font-bold text-[#00FFFF] uppercase tracking-wider">
                                    ...
                                    <button
                                      ...
                                      className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg font-bold uppercase text-[8px] tracking-wider transition-all duration-300 ${hasFeedback
                                        ? 'bg-blue-400/10 border border-blue-400/40 hover:bg-blue-400 hover:text-black text-[#00FFFF] cursor-pointer hover:shadow-[0_0_10px_rgba(0,255,65,0.2)] hover:scale-[1.02] active:scale-[0.98]'
                                        : 'bg-zinc-900/40 border border-zinc-800/60 text-slate-600 cursor-not-allowed opacity-60'
                                        }`}
                                    >
                                      {isDownloading ? (
                                        <>
                                          <span className="w-2.5 h-2.5 border border-blue-400/50 border-t-blue-400 rounded-full animate-spin" />
                                          <span>Fetching...</span>
                                        </>
                                      ) : (
                                        <>
                  ...
                  <div className="relative z-10 flex items-center justify-between gap-4 px-6 py-5">
                    ...
                    <div className="shrink-0 flex items-center gap-3">
                      ...
                      <motion.div
                        ...
                        className="flex items-center gap-2 bg-[#3B82F6] text-black text-xs font-mono font-black uppercase tracking-widest px-5 py-2.5 rounded-lg shadow-[0_0_20px_rgba(0,255,255,0.35)] group-hover:shadow-[0_0_30px_rgba(0,255,255,0.55)] transition-shadow duration-300"
                      >
          ...
          >
            <button
              ...
              className={`group relative w-full font-extrabold py-3.5 px-4 rounded-none border transition-all duration-300 font-sans text-xs uppercase tracking-widest flex items-center justify-center gap-2 font-mono-custom lab-btn-ripple ${hasSelectedProblem || isSelectionEnabled
                ? 'bg-blue-400 text-black border-blue-400 hover:bg-blue-400 hover:border-blue-400 cursor-pointer shadow-[0_0_15px_rgba(0,255,255,0.3)] hover:shadow-[0_0_25px_rgba(0,255,255,0.5)]'
            ...
            <button
              ...
              className="group relative w-full bg-[var(--bg-secondary)] hover:bg-blue-400 text-[#00FFFF] hover:text-black font-extrabold py-3.5 px-4 rounded-sm border border-blue-400/50 hover:border-blue-400 transition-all duration-300 font-sans text-xs uppercase tracking-widest cursor-pointer flex items-center justify-center gap-2 lab-btn-ripple"
            >
